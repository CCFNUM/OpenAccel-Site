  ...
  return (
    <>
      ...
      <section id="geometry">
        ...
        <TutorialFigure
          src="/figures/flexible_bottom_cavity.png"
      ...
      <section id="results">
        ...
        <TutorialSubfigureRow
          left={{ src: '/figures/u_x_cavity_flex.png', alt: 'Horizontal displacement (undamped)', subcaption: 'Horizontal displacement u_x(A, t)' }}
          right={{ src: '/figures/u_y_cavity_flex.png', alt: 'Vertical displacement (undamped)', subcaption: 'Vertical displacement u_y(A, t)' }}
        ...
        />
        <TutorialSubfigureRow
          left={{ src: '/figures/u_x_cavity_flex_damped.png', alt: 'Horizontal displacement (damped)', subcaption: 'Horizontal displacement u_x(A, t), damped run' }}
          right={{ src: '/figures/u_y_cavity_flex_damped.png', alt: 'Vertical displacement (damped)', subcaption: 'Vertical displacement u_y(A, t), damped run' }}
        ...
        <TutorialSubfigureRow
          left={{ src: '/figures/cavity_flex_contour_openaccel.png', alt: 'OpenAccel steady-state field', subcaption: 'OpenAccel' }}
