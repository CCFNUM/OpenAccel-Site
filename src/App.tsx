...
const ThCh5  = lazy(() => import('@/pages/theory/Ch5Heat').then(m => ({ default: m.Ch5Heat })));
const ThCh6  = lazy(() => import('@/pages/theory/Ch6Buoyancy').then(m => ({ default: m.Ch6Buoyancy })));
const ThCh7  = lazy(() => import('@/pages/theory/Ch7MovingDomains').then(m => ({ default: m.Ch7MovingDomains })));
const ThCh8  = lazy(() => import('@/pages/theory/Ch8FreeSurface').then(m => ({ default: m.Ch8FreeSurface })));
...
const ThCh13 = lazy(() => import('@/pages/theory/Ch13BoundaryConditions').then(m => ({ default: m.Ch13BoundaryConditions })));
const ThCh14 = lazy(() => import('@/pages/theory/Ch14Interfaces').then(m => ({ default: m.Ch14Interfaces })));
const ThCh15 = lazy(() => import('@/pages/theory/Ch15PvCoupling').then(m => ({ default: m.Ch15PvCoupling })));
const ThCh16 = lazy(() => import('@/pages/theory/Ch16LinearSolvers').then(m => ({ default: m.Ch16LinearSolvers })));
    ...
    <Layout>
      <Suspense fallback={<PageSkeleton />}>
        <Switch>
          ...
          <Route path="/theory/heat"                       component={ThCh5} />
          <Route path="/theory/buoyancy-pressure"          component={ThCh6} />
          <Route path="/theory/moving-domains"             component={ThCh7} />
          <Route path="/theory/free-surface"               component={ThCh8} />
          ...
          <Route path="/theory/boundary-conditions"        component={ThCh13} />
          <Route path="/theory/interfaces"                 component={ThCh14} />
          <Route path="/theory/pv-coupling"                component={ThCh15} />
          <Route path="/theory/linear-solvers"             component={ThCh16} />
